package com.hong.ad.index.keyword;
 ...
 * @Author: ZhangDeHong
 * @Describe: TODO
 * @Date Create in  9:01 PM 2020/1/30
 */
@Slf4j
@Component
public class UnitKeyWordIndex implements IndexAware<String, Set<Long>> {
    ...
    public boolean match (Long unitId, List<String> keywords) {
        if (keywordUnitMap.containsKey(unitId) && CollectionUtils.isNotEmpty(unitKeywordMap.get(unitId))) {
